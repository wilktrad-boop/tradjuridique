    ...
    <>
      ...
      <section className="py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 prose prose-navy max-w-none">
          ...
          <p className="text-navy-600 leading-relaxed">
            Pour exercer ces droits, contactez-nous à l&apos;adresse : <a href="mailto:contact@in-and-out-traduction.com" className="text-gold-600 hover:underline">contact@in-and-out-traduction.com</a>
          </p>
